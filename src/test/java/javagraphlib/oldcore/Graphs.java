...
public class Graphs {
     ...
     * {@link Graph#addConnector(Object, Object)} method.
     *
     ...
     * null</code>.
     *
     * @see Graph#addConnector(Object, Object)
     */
    public static <V,E> void ddConnector(Graph<V, E> g, V sourceNode, V targetNode, double weight)
    {
     ...
     * null</code>.
     */
    public static <V, E> E addConnectorWithVertices(Graph<V, E> g, V sourceNode, V targetNode)
    {
    ...
    public static <V, E> void addAllConnectors(
            Graph<? super V, ? super E> destination, Graph<V, E> source, Collection<? extends E> connectors)
    {
     ...
     * progress. This method will invoke the {@link Graph#addNode(Object)} method.
     *
     * @param destination the graph to which connectors are to be added
     ...
     *
     * <p>
     * The method uses {@link Graph#connectorsOf(Object)} to traverse the graph.
     *
     ...
     */
    public static <V, E> List<V> neighborListOf(Graph<V, E> g, V node)
    {
     ...
     *
     * <p>
     * The method uses {@link Graph#incomingConnectorsOf(Object)} to traverse the graph.
     *
     ...
     */
    public static <V, E> List<V> predecessorListOf(Graph<V, E> g, V node)
    {
     ...
     *
     * <p>
     * The method uses {@link Graph#outgoingConnectorsOf(Object)} to traverse the graph.
     *
     ...
     */
    public static <V, E> List<V> successorListOf(Graph<V, E> g, V node)
    {
     ...
     */
    public static <V, E> V getOppositeNode(Graph<V, E> g, E e, V v)
    {
     ...
     * @param <E> the graph connector type
     */
    public static <V, E> void addOutgoingConnectors(Graph<V, E> graph, V source, Iterable<V> targets)
    {
     ...
     * @param <E> the graph connector type
     */
    public static <V, E> void addIncomingConnectors(Graph<V, E> graph, V target, Iterable<V> sources)
    {
        if (!graph.containsNode(target)) {
            graph.addNode(target);
        }
     ...
     */
    public static <V, E> boolean nodeHasSuccessors(Graph<V, E> graph, V node)
    {
     ...
     */
    public static <V, E> boolean nodeHasPredecessors(Graph<V, E> graph, V node)
    {
