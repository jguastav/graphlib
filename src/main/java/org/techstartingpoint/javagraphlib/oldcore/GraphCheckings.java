...
public class GraphCheckings {
    ...
    public static <V, E> boolean isEmpty(org.techstartingpoint.javagraphlib.core.Graph<V, E> graph)
    {
     ...
     */
    public static <V, E> boolean isSimple(org.techstartingpoint.javagraphlib.core.Graph<V, E> graph)
    {
        Objects.requireNonNull(graph, GRAPH_CANNOT_BE_NULL);
        ...
        for (V v : graph.nodeSet()) {
            ...
            for (E e : graph.outgoingConnectorsOf(v)) {
                V u = org.techstartingpoint.javagraphlib.core.Graphs.getOppositeNode(graph, e, v);
     ...
     */
    public static <V, E> boolean isConnected(org.techstartingpoint.javagraphlib.core.Graph<V, E> graph)
    {
            // TODO: Write algorithm
        return false;
    }

    public static <V, E> boolean hasCycle(org.techstartingpoint.javagraphlib.core.Graph<V, E> graph)
    {
        // TODO: Write algorithm
        return false;
    }
