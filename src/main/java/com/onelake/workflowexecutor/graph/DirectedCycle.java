 ...
 *  Dependencies: DirectedGraph.java Stack.java StdOut.java In.java
 *  Data files:   http://algs4.cs.princeton.edu/42DirectedGraph/tinyDG.txt
 *                http://algs4.cs.princeton.edu/42DirectedGraph/tinyDAG.txt
 *
 *  Finds a directed cycle in a DirectedGraph.
 *  Runs in O(E + V) time.
 *
 ...
 *  see <a href="http://algs4.cs.princeton.edu/42DirectedGraph">Section 4.2</a> of
